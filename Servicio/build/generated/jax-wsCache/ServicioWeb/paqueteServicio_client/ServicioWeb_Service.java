 ...
 * 
 */
@WebServiceClient(name = "ServicioWeb", targetNamespace = "http://paqueteServicio/", wsdlLocation = "http://localhost:8080/Servicio/ServicioWeb?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVICIOWEB_QNAME = new QName("http://paqueteServicio/", "ServicioWeb");
    ...
    public ServicioWeb getServicioWebPort() {
        return super.getPort(new QName("http://paqueteServicio/", "ServicioWebPort"), ServicioWeb.class);
    }
    ...
    public ServicioWeb getServicioWebPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://paqueteServicio/", "ServicioWebPort"), ServicioWeb.class, features);
    }
